...
/*Once finished see if it compiles using arm-none-eabi-gcc stm32f407_startup.c -o stm32f407_startup.o
you can check it then by using arm-none-eabi-objdump -h stm32f407_startup.o*/


// arm-none-eabi-gcc -c main.c -o main.o
// arm-none-eabi-gcc -nostdlib -T stm32407_ls.ld *.o -o stm32f407_blink.elf

//to build for micro
//arm-none-eabi-gcc -c -mcpu=cortex-m4 -mthumb -std=gnu11 main.c -o main.o

//arm-none-eabi-gcc -c -mcpu=cortex-m4 -mthumb -std=gnu11 stm32f407_statrtup.c -o stm32f407_statrtup.o
