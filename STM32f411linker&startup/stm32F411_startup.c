...
/*Once finished see if it compiles using arm-none-eabi-gcc stm32f411_startup.c -o stm32f411_startup.open
you can check it then by using arm-none-eabi-objdump -h stm32f411_startup.o*/


// arm-none-eabi-gcc -c main.c -o main.o
// arm-none-eabi-gcc -nostdlib -T stm32411_ls.ld *.o -o stm32f411_blink.elf

//to build for micro
//arm-none-eabi-gcc -c -mcpu = cortex m4 -mthumb -std = gnu11 main.c -o main.o

//arm-none-eabi-gcc -c -mcpu = cortex m4 -mthumb -std = gnu11 stm32f411_statrtup.c -o stm32f411_statrtup.o
...
(gdb) monitor flash write_image erase stm32_blink.elf
(gdb) monitor reset init
(gdb) monitor resume
*/
...
void PVD_IRQHandler    				      (void)__attribute__((weak,alias("Default_Handler"))); /* EXTI Line 16 interrupt / PVD through EXTI*/
void TAMP_STAMP_IRQHandler   		    (void)__attribute__((weak,alias("Default_Handler"))); /* Tamper and TimeStamp interrupts through */
...
void SPI5_IRQHandler    			      (void)__attribute__((weak,alias("Default_Handler"))); /* SPI 5 global interrupt */
