...
/*Once finished see if it compiles using arm-none-eabi-gcc stm32f446_startup.c -o stm32f446_startup.o
you can check it then by using arm-none-eabi-objdump -h stm32f446_startup.o*/


// arm-none-eabi-gcc -c main.c -o main.o
// arm-none-eabi-gcc -nostdlib -T stm32446_ls.ld *.o -o stm32f446_blink.elf

//to build for micro
//arm-none-eabi-gcc -c -mcpu=cortex-m4 -mthumb -std=gnu11 main.c -o main.o

//arm-none-eabi-gcc -c -mcpu=cortex-m4 -mthumb -std=gnu11 stm32f446_statrtup.c -o stm32f446_statrtup.o
...
/*vector table in reference docunent*/
  ...
  void	OTG_HS_EP1_OUT_IRQHandler     (void)__attribute__((weak,alias("Default_Handler")));    			/* USB On The Go HS End Point 1 Out                                   */
  void	OTG_HS_EP1_IN_IRQHandler      (void)__attribute__((weak,alias("Default_Handler")));     			/* USB On The Go HS End Point 1 In                                    */
  void	OTG_HS_WKUP_IRQHandler        (void)__attribute__((weak,alias("Default_Handler")));       			/* USB On The Go HS Wakeup                                            */
  ...
  void	SPI4_IRQHandler               (void)__attribute__((weak,alias("Default_Handler")));              			/* SPI 4 global interrupt                                             */
  ...
  void	HDMI_CEC_IRQHandler           (void)__attribute__((weak,alias("Default_Handler")));          			/* HDMI-CEC global interrupt                                          */
  void	SPDIF_Rx_IRQHandler           (void)__attribute__((weak,alias("Default_Handler")));          			/* SPDIF-Rx global interrupt                                          */
  void	FMPI2C1_IRQHandler            (void)__attribute__((weak,alias("Default_Handler")));           			/* FMPI2C1 event interrupt                                            */
  void	FMPI2C1_error_IRQHandler      (void)__attribute__((weak,alias("Default_Handler")));     			/* FMPI2C1 error interrupt                                            */
