...
void USART1_Tx_Init(void) {
    ...
    GPIOA->CRH |= (GPIO_CRH_CNF9_1 | GPIO_CRH_MODE9_0); // AF push-pull, 10MHz

    // Configure USART1 (assuming 8 MHz PCLK, set baud rate to 9600)
    USART1->BRR = 0x341; // Baud rate (8MHz / 9600)
