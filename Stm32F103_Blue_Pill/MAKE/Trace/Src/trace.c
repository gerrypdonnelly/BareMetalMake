...
/* Forward declare */
static int mini_vsnprintf(char *buf, int size, const char *fmt, va_list args);
static void int_to_str(int v, char *buf);
static void uint_to_str(unsigned v, char *buf);
static void hex_to_str(unsigned v, char *buf);
